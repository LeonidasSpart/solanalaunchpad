  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-purple-400 text-sm font-semibold uppercase tracking-wider">SPL Token Guide</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          Create an SPL Token: <br className="hidden sm:block" />
          <span className="text-purple-400">Step-by-Step Guide</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-6 text-sm">
          ...
          <div className="bg-zinc-800/50 rounded-xl px-4 py-2 border border-zinc-700">
            ...
            <span className="text-zinc-500 ml-2">to Create</span>
          </div>
          <div className="bg-zinc-800/50 rounded-xl px-4 py-2 border border-zinc-700">
            <span className="text-white font-semibold">💰 0.15 SOL</span>
            <span className="text-zinc-500 ml-2">Starting From</span>
          </div>
        </div>
      </div>
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              ...
              <p className="text-zinc-400 text-sm mt-2 pl-9">
                To build trust, you can revoke Mint, Freeze, and Update authorities. This proves the supply won't change and the metadata is locked. Learn more on our <a href="/revoke" className="text-purple-400 hover:underline">Revoke Authority page</a>.
              </p>
            </div>
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              ...
              <p className="text-zinc-400 text-sm mt-1">
                With ZRP, you can test for FREE on devnet. Mainnet costs start from 0.15 SOL for a basic token. See our <a href="/pricing" className="text-purple-400 hover:underline">Pricing page</a> for complete details.
              </p>
            </div>
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
