  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-purple-400 text-sm font-semibold uppercase tracking-wider">Staking Guide</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          Solana Token Staking: <br className="hidden sm:block" />
          <span className="text-purple-400">How It Works &amp; Best Practices</span>
        </h1>
      ...
      <div className="bg-zinc-900 rounded-xl p-6 md:p-8 border border-zinc-800 space-y-12 text-zinc-300 text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-xl p-4 mt-4">
            <p className="text-yellow-400 text-sm font-semibold">⚠️ Staking Requires Development</p>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800 text-center">
              ...
              <p className="text-zinc-500 text-xs">Tokens are locked in a program</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800 text-center">
              <p className="text-2xl mb-1">🎁</p>
              <p className="text-white font-semibold text-xs">Rewards</p>
              <p className="text-zinc-500 text-xs">Stakers earn rewards</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800 text-center">
              <p className="text-2xl mb-1">⏳</p>
              <p className="text-white font-semibold text-xs">Time Periods</p>
              <p className="text-zinc-500 text-xs">Lock periods or vesting</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800 text-center">
              <p className="text-2xl mb-1">📉</p>
              <p className="text-white font-semibold text-xs">Reduced Supply</p>
              <p className="text-zinc-500 text-xs">Removed from circulation</p>
            </div>
          </div>
          <p className="mt-3">
            Staking creates incentives for holders to keep tokens rather than sell them. This can reduce selling pressure and create more stable price action. Learn more about <Link href="/tokenomics" className="text-purple-400 hover:underline">tokenomics design</Link> and how staking fits into your economic model.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 bg-black/40 rounded-lg p-2 border border-zinc-800">
              <span className="bg-purple-600 text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0">1</span>
              <p className="text-zinc-400 text-sm">User approves token transfer to staking program</p>
            </div>
            <div className="flex items-center gap-3 bg-black/40 rounded-lg p-2 border border-zinc-800">
              <span className="bg-purple-600 text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0">2</span>
              <p className="text-zinc-400 text-sm">Tokens are locked in the staking pool</p>
            </div>
            <div className="flex items-center gap-3 bg-black/40 rounded-lg p-2 border border-zinc-800">
              <span className="bg-purple-600 text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0">3</span>
              <p className="text-zinc-400 text-sm">Rewards accumulate based on staking amount and duration</p>
            </div>
            <div className="flex items-center gap-3 bg-black/40 rounded-lg p-2 border border-zinc-800">
              <span className="bg-purple-600 text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0">4</span>
              <p className="text-zinc-400 text-sm">User can claim rewards periodically</p>
            </div>
            <div className="flex items-center gap-3 bg-black/40 rounded-lg p-2 border border-zinc-800">
              <span className="bg-purple-600 text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0">5</span>
              <p className="text-zinc-400 text-sm">After lock period, user can unstake and withdraw tokens</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              ...
              <p className="text-zinc-400 text-sm mt-1">Develop a custom Solana program for staking. Gives you full control over mechanics and rewards. Requires Solana development knowledge or hiring a developer.</p>
              <div className="flex flex-wrap gap-2 mt-2">
                <span className="text-xs bg-green-900/30 text-green-400 px-2 py-0.5 rounded-full">Most flexible</span>
                <span className="text-xs bg-yellow-900/30 text-yellow-400 px-2 py-0.5 rounded-full">Most complex</span>
              </div>
            </div>

            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              <h3 className="text-white font-semibold">📦 Option 2: Use Existing Staking Platform</h3>
              <p className="text-zinc-400 text-sm mt-1">Use an existing staking platform or service that supports your token. Less control but faster to implement.</p>
              <div className="flex flex-wrap gap-2 mt-2">
                <span className="text-xs bg-green-900/30 text-green-400 px-2 py-0.5 rounded-full">Faster to implement</span>
                <span className="text-xs bg-yellow-900/30 text-yellow-400 px-2 py-0.5 rounded-full">Less control</span>
              </div>
            </div>

            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              <h3 className="text-white font-semibold">🤝 Option 3: Partner with Staking Service</h3>
              <p className="text-zinc-400 text-sm mt-1">Partner with a staking service provider that can implement staking for your token. They handle development and maintenance.</p>
              <div className="flex flex-wrap gap-2 mt-2">
                <span className="text-xs bg-green-900/30 text-green-400 px-2 py-0.5 rounded-full">No development needed</span>
                <span className="text-xs bg-yellow-900/30 text-yellow-400 px-2 py-0.5 rounded-full">Requires partnership</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800">
              ...
              <p className="text-zinc-400 text-xs mt-1">Stakers earn more of the same token. Requires mint authority or reserved supply.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800">
              <p className="text-white font-semibold text-sm">💎 Different Token Rewards</p>
              <p className="text-zinc-400 text-xs mt-1">Stakers earn a different token (like SOL). Requires holding the reward token in a pool.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800">
              <p className="text-white font-semibold text-sm">📊 Percentage-Based</p>
              <p className="text-zinc-400 text-xs mt-1">Rewards calculated as a percentage of staked amount (APY). Common and easy to understand.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800">
              <p className="text-white font-semibold text-sm">📈 Variable Rates</p>
              <p className="text-zinc-400 text-xs mt-1">Reward rates change based on total staked, time, or other factors. More complex but can balance incentives.</p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800">
              ...
              <p className="text-zinc-400 text-xs mt-1">Design reward rates that are sustainable long-term. Balance attractive rates with sustainability.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800">
              <h3 className="text-white font-semibold text-sm">📋 Clear Terms</h3>
              <p className="text-zinc-400 text-xs mt-1">Clearly communicate staking terms: lock periods, reward rates, unstaking conditions, and risks.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800">
              <h3 className="text-white font-semibold text-sm">🔒 Security First</h3>
              <p className="text-zinc-400 text-xs mt-1">Ensure staking programs are secure and audited. Staking involves locking tokens, so security is critical.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 border border-zinc-800">
              <h3 className="text-white font-semibold text-sm">💰 Reward Pool Management</h3>
              <p className="text-zinc-400 text-xs mt-1">Plan how to fund and maintain reward pools. Ensure sustainable funding for rewards.</p>
            </div>
          </div>
        </section>
