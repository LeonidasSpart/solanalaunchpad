  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-[#FF2D2D] text-sm font-semibold uppercase tracking-wider">Distribution Guide</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          Solana Token <br className="hidden sm:block" />
          <span className="text-[#FF2D2D]">Distribution Strategies</span>
        </h1>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            ...
            <p className="text-[#BDDBDB] text-sm mt-1">
              Distribution planning should happen <span className="text-white font-medium">before</span> you create your token. Combined with a solid <Link href="/launch" className="text-[#FF2D2D] hover:text-[#B10000] transition">launch strategy</Link> and proper <Link href="/pricing" className="text-[#FF2D2D] hover:text-[#B10000] transition">budget planning</Link>, effective distribution sets your token up for long-term success.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Everyone has equal access to your token at launch. No presales, no insider allocations. This is the most decentralized approach and builds maximum trust.</p>
              <div className="grid grid-cols-2 gap-2 mt-3">
                <div className="bg-[#FF2D2D]/10 rounded-lg p-2 border border-[#FF2D2D]/20">
                  <p className="text-[#FF2D2D] text-xs font-semibold">Advantages</p>
                  <ul className="list-disc pl-4 text-[#BDDBDB] text-xs space-y-0.5">
                ...
                <div className="bg-[#FF2D2D]/10 rounded-lg p-2 border border-[#FF2D2D]/20">
                  <p className="text-[#FF2D2D] text-xs font-semibold">Disadvantages</p>
                  <ul className="list-disc pl-4 text-[#BDDBDB] text-xs space-y-0.5">
              ...
              <p className="text-[#BDDBDB] text-xs mt-2">Best for: Community-driven projects, memecoins, projects prioritizing decentralization</p>
            </div>

            {/* Presale */}
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-lg">💰 Presale</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Early supporters buy tokens before public launch, often at a discount. Raises capital for development, marketing, and liquidity while rewarding early supporters.</p>
              <div className="grid grid-cols-2 gap-2 mt-3">
                <div className="bg-[#FF2D2D]/10 rounded-lg p-2 border border-[#FF2D2D]/20">
                  <p className="text-[#FF2D2D] text-xs font-semibold">Advantages</p>
                  <ul className="list-disc pl-4 text-[#BDDBDB] text-xs space-y-0.5">
              ...
              <p className="text-[#BDDBDB] text-xs mt-2">Best for: Projects needing capital, utility tokens, projects with clear roadmaps</p>
            </div>

            {/* Airdrop */}
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-lg">🎁 Airdrop</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Distribute free tokens to community members as rewards for early participation, referrals, or community engagement. Builds community and rewards supporters.</p>
              <div className="grid grid-cols-2 gap-2 mt-3">
                <div className="bg-[#FF2D2D]/10 rounded-lg p-2 border border-[#FF2D2D]/20">
                  <p className="text-[#FF2D2D] text-xs font-semibold">Advantages</p>
                  <ul className="list-disc pl-4 text-[#BDDBDB] text-xs space-y-0.5">
              ...
              <p className="text-[#BDDBDB] text-xs mt-2">Best for: Rewarding communities, promoting engagement, decentralizing ownership</p>
            </div>
            ...
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4">
              ...
              <p className="text-[#BDDBDB] text-xs mt-2">Best for: Projects wanting to balance capital, decentralization, and community</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-xs">30–50% — Main distribution pool</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <p className="text-white font-semibold text-sm">Team & Advisors</p>
              <p className="text-[#BDDBDB] text-xs">10–20% — Usually vested over time</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <p className="text-white font-semibold text-sm">Development & Treasury</p>
              <p className="text-[#BDDBDB] text-xs">20–30% — For future development</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <p className="text-white font-semibold text-sm">Community Rewards</p>
              <p className="text-[#BDDBDB] text-xs">10–15% — For airdrops, contests, staking</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <p className="text-white font-semibold text-sm">Liquidity</p>
              <p className="text-[#BDDBDB] text-xs">5–10% — For DEX liquidity pools</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <p className="text-white font-semibold text-sm">Partnerships</p>
              <p className="text-[#BDDBDB] text-xs">5–10% — For strategic partnerships</p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              ...
              <ul className="list-disc pl-5 mt-1 text-[#BDDBDB] text-xs space-y-0.5">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-3 mt-3">
            <p className="text-[#FF2D2D] text-xs">💡 Use ZRP's built-in <Link href="/airdrop" className="text-[#FF2D2D] hover:text-[#B10000] transition">Airdrop Tool</Link> for seamless distribution.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Publish your allocation plan, explain your reasoning, and update the community on distribution progress.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">🐋 Avoid Whale Concentration</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Use participation limits and fair distribution to prevent a small number of wallets from holding too much.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">📈 Plan for Long-Term</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Don't distribute everything at launch. Reserve tokens for future development, partnerships, and community growth.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">⏳ Consider Vesting</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Use vesting schedules for team allocations and presale tokens to align incentives and prevent immediate dumps.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Holding 50%+ of supply creates centralization concerns and reduces trust. Distribute tokens widely.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Lack of Transparency</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Hiding allocation or distribution plans raises red flags. Be transparent about how tokens are distributed.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 No Vesting for Team</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Team tokens without vesting can be dumped immediately, damaging price and trust. Always vest team allocations.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Poor Presale Execution</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Unfair presale terms, lack of transparency, or poor execution can permanently damage reputation. Plan carefully.</p>
            </div>
          </div>
        </section>
