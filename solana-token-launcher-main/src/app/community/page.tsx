  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-[#FF2D2D] text-sm font-semibold uppercase tracking-wider">Community Guide</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          Build a Thriving <br className="hidden sm:block" />
          <span className="text-[#FF2D2D]">Token Community</span>
        </h1>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">⚠️ Start Before Launch</p>
            <p className="text-[#BDDBDB] text-sm mt-1">
              This guide covers everything you need to build and manage a thriving community for your Solana token. Community building starts <span className="text-white font-medium">before</span> you launch your token and continues indefinitely. Combine community building with effective <Link href="/marketing" className="text-[#FF2D2D] hover:text-[#B10000] transition">marketing</Link> and a solid <Link href="/launch" className="text-[#FF2D2D] hover:text-[#B10000] transition">launch strategy</Link> for maximum impact.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              ...
              <p className="text-[#BDDBDB] text-xs">Organic marketing</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">💡</p>
              <p className="text-white font-semibold text-xs">Feedback &amp; Ideas</p>
              <p className="text-[#BDDBDB] text-xs">Valuable project input</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">🌐</p>
              <p className="text-white font-semibold text-xs">Network Effects</p>
              <p className="text-[#BDDBDB] text-xs">Growing attraction</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">🤝</p>
              <p className="text-white font-semibold text-xs">Long-term Holding</p>
              <p className="text-[#BDDBDB] text-xs">Reduced volatility</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">✅</p>
              <p className="text-white font-semibold text-xs">Legitimacy</p>
              <p className="text-[#BDDBDB] text-xs">Shows serious commitment</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">💎</p>
              <p className="text-white font-semibold text-xs">Value Creation</p>
              <p className="text-[#BDDBDB] text-xs">Community contributions</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <ul className="list-disc pl-5 mt-1 space-y-0.5 text-[#BDDBDB] text-sm">
            ...
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Essential for announcements and reaching broader audiences. Use it for major updates, milestones, and engagement. See our <Link href="/marketing" className="text-[#FF2D2D] hover:text-[#B10000] transition">marketing guide</Link> for Twitter strategies.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Post regular updates even when there's no major news. Share progress, milestones, behind-the-scenes content, and upcoming plans.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">⚡ Quick Responses</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Respond to questions and comments quickly. Aim to respond within hours, not days. Quick responses show you care.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">🎉 Host Events</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">AMAs, contests, giveaways, milestone celebrations, and community challenges. Regular events keep engagement high.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">🎁 Provide Value</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Exclusive updates, early access to features, airdrops, educational content, and direct access to team members.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Word-of-mouth, viral content, partnerships, participation in broader Solana communities, and quality content that people want to share.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">📣 Referral Programs</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Create referral programs that reward members for bringing new people. Token rewards, exclusive access, or special roles.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">🤝 Cross-Community</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Engage authentically in other Solana communities. Build relationships genuinely. People will discover your project through authentic engagement.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Many projects create channels then abandon them. This kills momentum and shows lack of commitment. Stay active consistently.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Ignoring Questions and Feedback</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Not responding shows you don't value your community. Respond quickly and show you're listening.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Poor Moderation</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Letting spam, scams, or toxic behavior go unchecked drives away good members. Moderate actively and enforce rules.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Over-Promising</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Making promises you can't keep destroys trust. Be realistic. Under-promise and over-deliver.</p>
            </div>
          </div>
        </section>
