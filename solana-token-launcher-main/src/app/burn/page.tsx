  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-[#FF2D2D] text-sm font-semibold uppercase tracking-wider">Burn Mechanism</span>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">⚠️ Permanent Action</p>
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">💡 How It Works on Solana</p>
            <p className="text-[#BDDBDB] text-sm mt-1">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Creates a deflationary mechanism where supply decreases over time, potentially increasing token value.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">🔄 Buyback and Burn Programs</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Projects buy tokens from the market and burn them, rewarding holders by creating scarcity.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">🗑️ Removing Unsold Tokens</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Burn tokens from presales that didn't sell or for purposes no longer needed.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">🤝 Signaling Commitment</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">By permanently removing tokens, creators show they're not planning to dump supply, building trust with holders.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">⚠️ Important Warning</p>
            <p className="text-[#BDDBDB] text-sm mt-1">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <p className="text-[#FF2D2D] text-xs font-semibold">Note on Price Impact</p>
              <p className="text-[#BDDBDB] text-xs mt-1">Burning tokens is not a guarantee of price increases. Market conditions, utility, and other factors also affect price. Burning should be part of a broader <Link href="/tokenomics" className="text-[#FF2D2D] hover:text-[#B10000] transition">tokenomics strategy</Link>.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Burn a large amount of tokens once, typically at launch or after a milestone. Common for removing unsold presale tokens.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">📅 Regular Burns</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Burn tokens on a schedule (weekly, monthly, quarterly). Creates ongoing deflation and builds anticipation.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">🔄 Buyback and Burn</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Use revenue or fees to buy tokens from the market, then burn them. Reduces supply while supporting price.</p>
            </div>
          </div>
        </section>
