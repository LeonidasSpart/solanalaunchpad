    ...
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          ...
          <span className="text-[#FF2D2D]">Complete Protection Guide</span>
        </h1>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">🔒 Start with Security</p>
            <p className="text-[#BDDBDB] text-sm mt-1">
              Whether you're creating a token or holding tokens, understanding security best practices protects you and your community. Combine this with our <Link href="/revoke" className="text-[#FF2D2D] hover:text-[#B10000] transition">authority revocation guide</Link> and <Link href="/guide" className="text-[#FF2D2D] hover:text-[#B10000] transition">launch strategy</Link> for complete protection.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">Hardware Wallet Benefits:</p>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Protects holders from dilution.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <p className="text-white font-semibold text-sm">🛡️ Protects Against Hacks</p>
              <p className="text-[#BDDBDB] text-xs mt-1">Attackers can't abuse revoked authorities.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <p className="text-white font-semibold text-sm">🤝 Builds Holder Trust</p>
              <p className="text-[#BDDBDB] text-xs mt-1">Shows you can't change token fundamentals.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <p className="text-white font-semibold text-sm">🔍 Verifiable Security</p>
              <p className="text-[#BDDBDB] text-xs mt-1">Revoked authorities are visible on-chain.</p>
            </div>
          </div>
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-4 mt-4">
            ...
            <p className="text-[#BDDBDB] text-sm mt-1">
              For serious projects, revoking authorities is a security best practice. Learn how to do this on our <Link href="/revoke" className="text-[#FF2D2D] hover:text-[#B10000] transition">Revoke Authority page</Link>.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-4 mb-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">✅ Commitment Signal</p>
            <p className="text-[#BDDBDB] text-sm mt-1">Locked liquidity proves you can't abandon the project and drain funds. Many successful projects lock liquidity for 6-12 months or longer.</p>
          </div>

          <h3 className="text-white font-semibold mt-4 mb-3">Adequate Liquidity Amounts</h3>
          <p className="text-[#BDDBDB] text-sm">Too little liquidity creates poor trading experience and high slippage. Too much liquidity locks up unnecessary capital. Find the right balance for your project's needs.</p>
          <ul className="list-disc pl-5 mt-2 space-y-1 text-[#BDDBDB] text-sm">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Creators drain liquidity pools or abandon projects, leaving holders with worthless tokens.</p>
              <p className="text-[#FF2D2D] text-sm mt-2 font-medium">How to prevent:</p>
              <p className="text-[#BDDBDB] text-sm">Revoke mint authority, lock liquidity, use audited contracts, and research project teams.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Phishing Attacks</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Attackers trick you into revealing private keys or seed phrases via fake websites or malicious links.</p>
              <p className="text-[#FF2D2D] text-sm mt-2 font-medium">How to prevent:</p>
              <p className="text-[#BDDBDB] text-sm">Always verify URLs, never click suspicious links, use bookmarks for trusted sites, never share seed phrases.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Malware and Keyloggers</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Malware can steal private keys or seed phrases from your computer.</p>
              <p className="text-[#FF2D2D] text-sm mt-2 font-medium">How to prevent:</p>
              <p className="text-[#BDDBDB] text-sm">Use hardware wallets, keep software updated, use antivirus, avoid suspicious downloads.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Smart Contract Exploits</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Vulnerable smart contracts can be exploited to drain funds or manipulate token behavior.</p>
              <p className="text-[#FF2D2D] text-sm mt-2 font-medium">How to prevent:</p>
              <p className="text-[#BDDBDB] text-sm">Use audited contracts, verify contract code, test thoroughly, use reputable platforms like ZRP.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-[#BDDBDB] text-sm mb-4">Run through this checklist before and after launching your token.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a]">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Use hardware wallet for project funds</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a]">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Store seed phrases offline and securely</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a]">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Revoke mint, freeze, and update authorities</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a]">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Lock liquidity pools for commitment</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a]">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Use strong, unique passwords everywhere</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a]">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Enable 2FA on all accounts</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a]">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Verify all URLs and transactions</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a]">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Never share private keys or seed phrases</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a] md:col-span-2">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Monitor for suspicious activity</span>
            </div>
            <div className="flex items-center gap-3 bg-[#050505]/40 rounded-xl px-4 py-3 border border-[#1a1a1a] md:col-span-2">
              <span className="text-[#FF2D2D] text-lg">✅</span>
              <span className="text-[#BDDBDB] text-sm">Use reputable, audited platforms</span>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">
                Use a hardware wallet, revoke dangerous authorities (mint, freeze, update), lock liquidity, verify smart contracts, use strong passwords, store seed phrases securely offline, and monitor for suspicious activity. See our <Link href="/revoke" className="text-[#FF2D2D] hover:text-[#B10000] transition">authority revocation guide</Link> for details.
              </p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
