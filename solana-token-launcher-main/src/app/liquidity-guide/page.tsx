// src/app/liquidity-guide/page.tsx
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-[#FF2D2D] text-sm font-semibold uppercase tracking-wider">Liquidity Guide</span>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">⚠️ Essential Step</p>
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-4 mt-4">
            ...
            <p className="text-[#BDDBDB] text-sm mt-1">Most successful token launches include liquidity from day one. It's part of a complete launch strategy.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a] text-center">
              <p className="text-[#BDDBDB] text-sm">Small Projects</p>
              <p className="text-2xl font-bold text-white">5-10 SOL</p>
              <p className="text-[#BDDBDB] text-xs">For testing or small communities</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#FF2D2D]/30 text-center">
              <p className="text-[#BDDBDB] text-sm">Standard Launch</p>
              <p className="text-2xl font-bold text-[#FF2D2D]">20-50 SOL</p>
              <p className="text-[#BDDBDB] text-xs">Most common starting point</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a] text-center">
              <p className="text-[#BDDBDB] text-sm">Serious Projects</p>
              <p className="text-2xl font-bold text-white">100-500+ SOL</p>
              <p className="text-[#BDDBDB] text-xs">For established projects</p>
            </div>
          </div>
          <p className="text-[#BDDBDB] text-xs text-center mt-3">Remember: you need equal value of both your token and SOL.</p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Best for: New token launches, high volume trading</p>
              <ul className="list-disc pl-5 mt-2 space-y-0.5 text-[#BDDBDB] text-sm">
              ...
              <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-2 mt-2">
                <p className="text-[#FF2D2D] text-xs font-medium">✅ Recommended for most new tokens</p>
              </div>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Orca</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Best for: Capital efficiency, advanced features</p>
              <ul className="list-disc pl-5 mt-2 space-y-0.5 text-[#BDDBDB] text-sm">
            ...
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Best for: Aggregator, best prices</p>
              <ul className="list-disc pl-5 mt-2 space-y-0.5 text-[#BDDBDB] text-sm">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <div className="flex items-center gap-3">
                <span className="bg-[#FF2D2D] text-white text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0">8</span>
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">⚠️ Understanding Impermanent Loss</p>
            <p className="text-[#BDDBDB] text-sm mt-1">
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Don't start with too little liquidity. Inadequate liquidity creates poor trading experience and high slippage.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">🔒 Lock Your Liquidity</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Consider locking your liquidity using services like Pump.fun. This shows commitment and prevents "rug pull" concerns.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Monitor and Adjust</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Regularly monitor your pool's performance. If trading volume is high but liquidity is low, consider adding more.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Avoid Removing Liquidity Early</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Removing liquidity shortly after launch looks unprofessional and can kill momentum. Plan to keep liquidity for at least the initial launch period.</p>
            </div>
          </div>
        </section>
