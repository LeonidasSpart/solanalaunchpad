  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-[#FF2D2D] text-sm font-semibold uppercase tracking-wider">Airdrop Guide</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          How to Airdrop Solana Tokens: <br className="hidden sm:block" />
          <span className="text-[#FF2D2D]">Complete Distribution Guide</span>
        </h1>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">⚠️ Plan Before You Start</p>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              ...
              <p className="text-[#BDDBDB] text-xs">Grow your user base</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-3xl mb-1">🎁</p>
              <p className="text-white font-semibold text-sm">Reward Supporters</p>
              <p className="text-[#BDDBDB] text-xs">Early community members</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-3xl mb-1">📢</p>
              <p className="text-white font-semibold text-sm">Create Awareness</p>
              <p className="text-[#BDDBDB] text-xs">Generate engagement</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-3xl mb-1">⚖️</p>
              <p className="text-white font-semibold text-sm">Fair Distribution</p>
              <p className="text-[#BDDBDB] text-xs">Launch and decentralize</p>
            </div>
          </div>
          <p className="text-[#BDDBDB] text-xs text-center mt-3">Airdrops can be one-time events or ongoing distributions. They're a common way to get tokens into the hands of users and build initial adoption.</p>
        </section>
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-3">
            ...
            <div className="bg-[#050505]/40 rounded-lg p-2 mt-2">
              <p className="text-[#BDDBDB] text-xs">Example: Airdropping to <span className="text-white font-medium">1,000 wallets</span> costs approximately <span className="text-[#FF2D2D] font-medium">0.005 SOL</span> in fees.</p>
            </div>
            <p className="text-[#BDDBDB] text-xs mt-1">Always have extra SOL for fees to ensure all transactions complete.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-2 pl-9">
                For small airdrops, send manually. For larger airdrops, use batch sending tools. <Link href="/airdrop" className="text-[#FF2D2D] hover:text-[#B10000] transition">ZRP's Airdrop Tool</Link> makes batch sending easy.
              </p>
            </div>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Use your wallet (Phantom, Solflare) to send tokens manually. Works well for small airdrops (under 50 recipients). Simple but time-consuming.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Batch Sending Tools</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Use tools that send tokens to multiple addresses automatically. <Link href="/airdrop" className="text-[#FF2D2D] hover:text-[#B10000] transition">ZRP's Airdrop Tool</Link> is designed for this — efficient, secure, and easy to use.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4">
              <p className="text-[#FF2D2D] text-sm font-semibold">🚀 Recommended: Use ZRP's Airdrop Tool</p>
              <p className="text-[#BDDBDB] text-sm mt-1">
                Our <Link href="/airdrop" className="text-[#FF2D2D] hover:text-[#B10000] transition">Airdrop Tool</Link> handles batch sending automatically. Simply enter your token mint, set the amount, paste wallet addresses, and send. No technical knowledge required.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Always verify recipient addresses before sending. Double-check addresses, especially when copying from lists or spreadsheets.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">✅ Test First</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">For large airdrops, test with a small batch first. Send to a few addresses to verify the process works correctly.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">✅ Keep Records</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Maintain records of all airdrop transactions. This helps verify distributions and address issues.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">✅ Communicate Clearly</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Inform recipients about the airdrop. Explain why they're receiving tokens, how much, and when to expect them.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">✅ Budget for Fees</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Always have extra SOL for fees. Transaction failures due to insufficient fees can delay or prevent distributions.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Insufficient SOL for Fees</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Not having enough SOL for transaction fees causes failed transactions. Always calculate fees and ensure you have extra SOL.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Wrong Addresses</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Sending to incorrect addresses means lost tokens. Always verify addresses before sending.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Not Testing First</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Executing large airdrops without testing can lead to errors affecting all recipients. Test with a small batch first.</p>
            </div>
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-3">
              <h3 className="text-white font-semibold text-sm">🚫 Poor Communication</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Not informing recipients about airdrops can cause confusion. Clear communication is essential for trust.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">
                Each airdrop transaction costs a small SOL fee, typically around <span className="text-white font-medium">0.000005 SOL</span> per transaction. For 1,000 recipients, fees total approximately <span className="text-[#FF2D2D] font-medium">0.005 SOL</span>.
              </p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Can I airdrop to thousands of wallets?</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">
                Yes, using batch sending tools like <Link href="/airdrop" className="text-[#FF2D2D] hover:text-[#B10000] transition">ZRP's Airdrop Tool</Link>. Manual sending to thousands of wallets is impractical. Large airdrops require significant SOL for fees.
              </p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
