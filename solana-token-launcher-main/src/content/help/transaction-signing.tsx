          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a] text-center">
              ...
              <div className="flex justify-center gap-4 mt-2">
                <span className="text-green-400 text-sm">✅ Extension</span>
                <span className="text-green-400 text-sm">✅ Mobile</span>
              </div>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a] text-center">
            ...
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 text-center md:col-span-3">
