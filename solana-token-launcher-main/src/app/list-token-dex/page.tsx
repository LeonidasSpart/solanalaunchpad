  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-[#FF2D2D] text-sm font-semibold uppercase tracking-wider">DEX Listing Guide</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          How to List Your Token <br className="hidden sm:block" />
          <span className="text-[#FF2D2D]">on Solana DEXs</span>
        </h1>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">⚠️ Next Step After Creation</p>
            <p className="text-[#BDDBDB] text-sm mt-1">
              This guide explains how to list your token on popular Solana DEXs like Raydium, Orca, and aggregators like Jupiter. Listing is the next step after creating your token and adding liquidity. Combined with a solid <Link href="/launch" className="text-[#FF2D2D] hover:text-[#B10000] transition">launch strategy</Link> and marketing efforts, proper DEX listing maximizes your token's reach and trading potential.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4">
              <h3 className="text-[#FF2D2D] font-semibold text-lg text-center">🔄 DEX (Decentralized Exchange)</h3>
              <ul className="list-disc pl-5 mt-3 space-y-1 text-[#BDDBDB] text-sm">
            ...
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4">
              <h3 className="text-[#FF2D2D] font-semibold text-lg text-center">🏦 CEX (Centralized Exchange)</h3>
              <ul className="list-disc pl-5 mt-3 space-y-1 text-[#BDDBDB] text-sm">
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-2 pl-9">
                First, add liquidity to Raydium. This creates a trading pair (typically your token/SOL). See our complete <Link href="/add-liquidity" className="text-[#FF2D2D] hover:text-[#B10000] transition">liquidity guide</Link> for detailed steps. Once liquidity is added, your token is automatically tradeable on Raydium. No application needed.
              </p>
            </div>
            ...
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-2 pl-9">
                Ensure your token metadata is complete and accurate. This includes name, symbol, logo, and description. Incomplete metadata can hurt visibility and trust. Verify your token on <a href="https://solscan.io" target="_blank" rel="noopener noreferrer" className="text-[#FF2D2D] hover:text-[#B10000] transition">Solscan</a> to ensure all information displays correctly.
              </p>
            </div>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Offers concentrated liquidity and better capital efficiency. After establishing on Raydium, consider adding liquidity to Orca for additional exposure. The process is similar — just add liquidity to create a trading pair.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">🪐 Jupiter Aggregator</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Jupiter is a liquidity aggregator, not a direct DEX. It searches across all Solana DEXs to find the best prices. Once your token has liquidity on Raydium or Orca, Jupiter automatically includes it in search results. No manual submission needed.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-[#BDDBDB] text-sm">
            <li><span className="text-white">Adequate Liquidity:</span> Minimum 10-20 SOL worth of liquidity, though 50+ SOL is better for visibility. See our <Link href="/add-liquidity" className="text-[#FF2D2D] hover:text-[#B10000] transition">liquidity guide</Link> for details.</li>
            ...
            <li><span className="text-white">Security Measures:</span> Revoked authorities and locked liquidity build trust. See our <Link href="/security" className="text-[#FF2D2D] hover:text-[#B10000] transition">security guide</Link>.</li>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-xs mt-1">Raydium has the largest user base and liquidity. Start here, then expand to other DEXs as your token grows.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">🔒 Lock Your Liquidity</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Locking liquidity shows commitment and prevents rug pull concerns. This builds trust and improves listing chances on tracking sites.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">📋 Complete All Metadata</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Incomplete metadata hurts visibility. Ensure your token has proper name, symbol, logo, description, and website links.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold text-sm">📢 Promote Your Listing</h3>
              <p className="text-[#BDDBDB] text-xs mt-1">Share your DEX listing links with your community. Include pool addresses in your marketing materials and make it easy for people to find and trade your token.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">
                First add liquidity to a platform like Raydium or Orca, ensure your token has proper metadata, and then share your trading pair address. Most DEXs automatically list tokens once liquidity is added. See our <Link href="/add-liquidity" className="text-[#FF2D2D] hover:text-[#B10000] transition">liquidity guide</Link> for step-by-step instructions.
              </p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
