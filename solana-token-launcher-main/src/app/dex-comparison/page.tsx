  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-purple-400 text-sm font-semibold uppercase tracking-wider">DEX Comparison</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          Best DEX for Solana Tokens: <br className="hidden sm:block" />
          <span className="text-purple-400">Complete Platform Comparison</span>
        </h1>
      ...
      <div className="bg-zinc-900 rounded-xl p-6 md:p-8 border border-zinc-800 space-y-12 text-zinc-300 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p className="text-zinc-400 text-sm">Raydium charges <span className="text-white font-medium">0.25%</span> trading fee for standard pools. Liquidity providers earn a portion of these fees. Creating a new pool requires providing initial liquidity (typically 10-50+ SOL worth).</p>

          <h3 className="text-white font-semibold mt-4 mb-2">Listing Requirements</h3>
          <p className="text-zinc-400 text-sm">To list on Raydium, you need to create a liquidity pool. This requires providing equal value of your token and SOL. No approval process — anyone can create a pool if they have liquidity. See our <Link href="/add-liquidity" className="text-purple-400 hover:underline">liquidity guide</Link> for details.</p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="bg-green-900/20 border border-green-500/30 rounded-xl p-4">
              <p className="text-green-400 font-semibold text-sm">✅ Pros</p>
            ...
            <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-4">
              <p className="text-red-400 font-semibold text-sm">❌ Cons</p>
              <ul className="list-disc pl-5 mt-1 space-y-0.5 text-zinc-400 text-xs">
          ...
          <p className="text-purple-400 text-xs font-medium mt-3">Best for: New token launches, tokens seeking high visibility, projects wanting farms/staking features.</p>
        </section>
        ...
        <section>
          ...
          <p className="text-purple-400 text-xs font-medium mt-3">Best for: Established tokens, high-volume trading, projects wanting lower fees, experienced liquidity providers.</p>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-400 text-sm">Jupiter doesn't require listing. Once your token has liquidity on any supported DEX (Raydium, Orca, etc.), it automatically appears on Jupiter. The aggregator splits large orders across multiple DEXs for best execution.</p>
          ...
          <p className="text-purple-400 text-xs font-medium mt-3">Best for: All tokens (automatic), users seeking best prices, large trades requiring split routing.</p>
        </section>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-black/40 border-b border-zinc-700">
                  ...
                  <th className="text-left py-3 px-4 text-purple-400 font-semibold">Raydium</th>
                  <th className="text-left py-3 px-4 text-blue-400 font-semibold">Orca</th>
                  <th className="text-left py-3 px-4 text-yellow-400 font-semibold">Jupiter</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-zinc-800">
                  <td className="py-3 px-4 text-white">Type</td>
                  <td className="py-3 px-4 text-zinc-300">AMM + Order Book</td>
                  <td className="py-3 px-4 text-zinc-300">Concentrated Liquidity</td>
                  <td className="py-3 px-4 text-zinc-300">Aggregator</td>
                </tr>
                <tr className="border-b border-zinc-800">
                  <td className="py-3 px-4 text-white">Trading Fees</td>
                  <td className="py-3 px-4 text-zinc-300">0.25%</td>
                  <td className="py-3 px-4 text-zinc-300">0.01-0.3%</td>
                  <td className="py-3 px-4 text-zinc-300">0.1% + DEX fees</td>
                </tr>
                <tr className="border-b border-zinc-800">
                  <td className="py-3 px-4 text-white">Listing Difficulty</td>
                  <td className="py-3 px-4 text-green-400">Easy</td>
                  <td className="py-3 px-4 text-green-400">Easy</td>
                  <td className="py-3 px-4 text-blue-400">Automatic</td>
                </tr>
                <tr className="border-b border-zinc-800">
                  <td className="py-3 px-4 text-white">Liquidity Required</td>
                  <td className="py-3 px-4 text-zinc-300">10-50+ SOL</td>
                  <td className="py-3 px-4 text-zinc-300">10-50+ SOL</td>
                  <td className="py-3 px-4 text-zinc-300">None (uses other DEXs)</td>
                </tr>
                <tr className="border-b border-zinc-800">
                ...
                <tr>
                  ...
                  <td className="py-3 px-4 text-purple-300">New launches</td>
                  <td className="py-3 px-4 text-blue-300">Established tokens</td>
                  <td className="py-3 px-4 text-yellow-300">All tokens</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              ...
              <p className="text-zinc-400 text-sm mt-1">Start with <span className="text-purple-400 font-medium">Raydium</span>. It's the easiest to list on, has high visibility, and attracts the most volume for new tokens. Once established, consider adding liquidity to Orca for better capital efficiency.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              <h3 className="text-white font-semibold text-lg">2️⃣ For Established Tokens</h3>
              <p className="text-zinc-400 text-sm mt-1">Use <span className="text-blue-400 font-medium">Orca</span> for lower fees and better capital efficiency. Consider a multi-DEX strategy with liquidity on both Raydium and Orca for maximum accessibility.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              <h3 className="text-white font-semibold text-lg">3️⃣ Multi-DEX Strategy</h3>
              <p className="text-zinc-400 text-sm mt-1">The best approach is listing on multiple DEXs. Start with Raydium, add Orca for efficiency, and your token will automatically appear on Jupiter. This maximizes liquidity and accessibility. See our <Link href="/list-token-dex" className="text-purple-400 hover:underline">DEX listing guide</Link> for details.</p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              ...
              <p className="text-zinc-400 text-sm mt-1">
                <span className="text-blue-400 font-medium">Orca</span> typically has the lowest fees at 0.01-0.3% depending on pool type. Raydium charges 0.25% for standard pools. Jupiter, as an aggregator, routes to the best prices but may include additional fees.
              </p>
            </div>
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              <h3 className="text-white font-semibold">Which DEX is easiest to list on?</h3>
              <p className="text-zinc-400 text-sm mt-1">
                <span className="text-purple-400 font-medium">Raydium</span> is generally the easiest to list on for new tokens. You can create a pool directly if you have liquidity. Orca requires pool creation but is also straightforward. Jupiter doesn't require listing — it aggregates from other DEXs automatically.
              </p>
            </div>
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
