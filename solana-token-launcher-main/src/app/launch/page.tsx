  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-purple-400 text-sm font-semibold uppercase tracking-wider">Launch Guide</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          Launch Solana Token: <br className="hidden sm:block" />
          <span className="text-purple-400">Complete Strategy Guide</span>
        </h1>
      ...
      <div className="bg-zinc-900 rounded-xl p-6 md:p-8 border border-zinc-800 space-y-12 text-zinc-300 text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-xl p-4 mt-4">
            <p className="text-yellow-400 text-sm font-semibold">⚠️ Don't Rush</p>
        ...
        <section>
          ...
          <div className="bg-purple-900/20 border border-purple-500/20 rounded-xl p-4 mb-4">
            <p className="text-purple-300 text-sm font-semibold">💡 Elevator Pitch</p>
            <p className="text-zinc-400 text-sm mt-1">Write down your token's purpose in one sentence. This becomes your elevator pitch.</p>
          </div>
          <p className="mb-2">Memecoins can be fun, but even they need a hook. What makes yours different? Is it the community? The artwork? The story? Identify what makes your token unique. Not sure whether to go the meme route or build real utility? Read our breakdown of <Link href="/guide" className="text-purple-400 hover:underline">token types</Link> before you decide.</p>
        ...
        <section>
          ...
          <p className="text-zinc-400 text-sm">Don't disappear after launch. Keep posting updates. Share milestones. Engage with your community. Active creators build stronger communities.</p>

          <h3 className="text-white font-semibold mt-4 mb-3">Build Trust</h3>
          <p className="text-zinc-400 text-sm">Consider revoking authorities to show commitment. This proves you can't change the token later. It builds trust with holders. Learn more in our <Link href="/revoke" className="text-purple-400 hover:underline">Revoke Authority guide</Link>.</p>

          <h3 className="text-white font-semibold mt-4 mb-3">Track Your Progress</h3>
          <p className="text-zinc-400 text-sm">Monitor your token on Solscan. Watch holder count. Track transactions. This data helps you understand your audience and adjust your strategy.</p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              ...
              <p className="text-zinc-400 text-sm mt-1">Don't rush to launch. Take time to prepare your branding, description, and social media. A rushed launch looks unprofessional.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              <h3 className="text-white font-semibold">🔍 Not Being Transparent</h3>
              <p className="text-zinc-400 text-sm mt-1">Be honest about your token's purpose and distribution. Hiding information destroys trust. Transparency builds it.</p>
            </div>
            <div className="bg-black/40 rounded-xl p-4 border border-zinc-800">
              <h3 className="text-white font-semibold">📉 Abandoning After Launch</h3>
              <p className="text-zinc-400 text-sm mt-1">Many creators launch and disappear. This kills momentum. Stay active. Keep building. Long-term commitment shows you're serious.</p>
            </div>
          </div>
        </section>
