  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-[#FF2D2D] text-sm font-semibold uppercase tracking-wider">Pricing Guide</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          Cost to Create a <br className="hidden sm:block" />
          <span className="text-[#FF2D2D]">Solana Token</span>
        </h1>
      ...
      {/* Devnet Banner */}
      <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-6 mb-12 text-center">
        <h3 className="text-[#FF2D2D] font-bold text-lg mb-2">🧪 Test on Devnet — Completely FREE</h3>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-6 text-center mb-4">
            <div className="text-4xl font-bold text-[#FF2D2D]">0.15 SOL</div>
            <p className="text-[#BDDBDB] text-sm mt-1">Base fee — covers token minting and basic metadata</p>
          </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-[#BDDBDB] text-xs">Revoke Mint Authority</p>
              <p className="text-[#FF2D2D] font-bold text-lg">+0.15 SOL</p>
              <p className="text-[#BDDBDB] text-xs">Prevents minting more tokens</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-[#BDDBDB] text-xs">Revoke Freeze Authority</p>
              <p className="text-[#FF2D2D] font-bold text-lg">+0.15 SOL</p>
              <p className="text-[#BDDBDB] text-xs">Prevents freezing accounts</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-[#BDDBDB] text-xs">Revoke Update Authority</p>
              <p className="text-[#FF2D2D] font-bold text-lg">+0.15 SOL</p>
              <p className="text-[#BDDBDB] text-xs">Makes metadata permanent</p>
            </div>
          </div>
          <p className="text-[#BDDBDB] text-xs">Revoke all three for maximum security. <span className="text-white font-medium">Cannot be undone once revoked.</span></p>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <div className="text-2xl font-bold text-[#FF2D2D] text-center">0.15 SOL</div>
              <ul className="list-disc pl-5 mt-2 space-y-0.5 text-[#BDDBDB] text-xs">
            ...
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <div className="text-2xl font-bold text-[#FF2D2D] text-center">0.30 SOL</div>
              <ul className="list-disc pl-5 mt-2 space-y-0.5 text-[#BDDBDB] text-xs">
                <li>Base fee: 0.15 SOL</li>
            ...
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4">
              ...
              <div className="text-2xl font-bold text-[#FF2D2D] text-center">0.60 SOL</div>
              <ul className="list-disc pl-5 mt-2 space-y-0.5 text-[#BDDBDB] text-xs">
                <li>Base fee: 0.15 SOL</li>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-[#1a1a1a]">
                  <th className="py-3 text-[#BDDBDB] text-xs font-medium">Feature</th>
                  <th className="py-3 text-[#BDDBDB] text-xs font-medium">Cost</th>
                  <th className="py-3 text-[#BDDBDB] text-xs font-medium">Description</th>
                </tr>
              </thead>
              <tbody className="text-sm">
                <tr className="border-b border-[#1a1a1a]">
                  <td className="py-3 text-white">Base Token Creation</td>
                  <td className="py-3 text-[#FF2D2D] font-bold">0.15 SOL</td>
                  <td className="py-3 text-[#BDDBDB]">Mint account, metadata, initial supply</td>
                </tr>
                <tr className="border-b border-[#1a1a1a]">
                  <td className="py-3 text-white">Revoke Mint Authority</td>
                  <td className="py-3 text-[#FF2D2D] font-bold">+0.15 SOL</td>
                  <td className="py-3 text-[#BDDBDB]">Prevents creating more tokens</td>
                </tr>
                <tr className="border-b border-[#1a1a1a]">
                  <td className="py-3 text-white">Revoke Freeze Authority</td>
                  <td className="py-3 text-[#FF2D2D] font-bold">+0.15 SOL</td>
                  <td className="py-3 text-[#BDDBDB]">Prevents freezing token accounts</td>
                </tr>
                <tr className="border-b border-[#1a1a1a]">
                  <td className="py-3 text-white">Revoke Update Authority</td>
                  <td className="py-3 text-[#FF2D2D] font-bold">+0.15 SOL</td>
                  <td className="py-3 text-[#BDDBDB]">Makes metadata permanent & immutable</td>
                </tr>
                <tr className="border-t-2 border-[#FF2D2D]">
                  <td className="py-3 text-white font-bold">Maximum Total</td>
                  <td className="py-3 text-[#FF2D2D] font-bold text-lg">0.60 SOL</td>
                  <td className="py-3 text-[#BDDBDB]">All features included</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <p className="text-[#BDDBDB] text-sm mt-1">Solana fees are tiny (~0.001 SOL per transaction). Budget ~0.01 SOL for all transactions.</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              <h3 className="text-white font-semibold">Wallet Balance</h3>
              <p className="text-[#BDDBDB] text-sm mt-1">Have at least <span className="text-white font-medium">0.2 SOL</span> for basic tokens. For all revocations, have at least <span className="text-white font-medium">0.7 SOL</span>.</p>
            </div>
          </div>
        </section>
