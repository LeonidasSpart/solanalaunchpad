  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-12">
        <span className="text-[#FF2D2D] text-sm font-semibold uppercase tracking-wider">Token Comparison</span>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">
          Meme Coin vs Utility Token: <br className="hidden sm:block" />
          <span className="text-[#FF2D2D]">Key Differences Explained</span>
        </h1>
      ...
      <div className="bg-[#0D0D0D] rounded-xl p-6 md:p-8 border border-[#1a1a1a] space-y-12 text-[#BDDBDB] text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/20 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">💡 Same Foundation, Different Purpose</p>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              ...
              <p className="text-[#BDDBDB] text-xs">Value from community engagement</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">🎭</p>
              <p className="text-white font-semibold text-xs">Entertainment-focused</p>
              <p className="text-[#BDDBDB] text-xs">Created for fun and humor</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">📈</p>
              <p className="text-white font-semibold text-xs">Speculative Value</p>
              <p className="text-[#BDDBDB] text-xs">Driven by hype and trends</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">🌐</p>
              <p className="text-white font-semibold text-xs">Cultural Relevance</p>
              <p className="text-[#BDDBDB] text-xs">Tied to memes and internet culture</p>
            </div>
          </div>
          <p className="mt-3">
            Meme coins can achieve significant market caps through community momentum, but they're also highly volatile and dependent on continued community engagement. Learn more about <Link href="/tokenomics" className="text-[#FF2D2D] hover:text-[#B10000] transition">tokenomics design</Link> for different token types.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              ...
              <p className="text-[#BDDBDB] text-xs">Provides access or benefits</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">🔗</p>
              <p className="text-white font-semibold text-xs">Platform Integration</p>
              <p className="text-[#BDDBDB] text-xs">Used within a specific ecosystem</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">📊</p>
              <p className="text-white font-semibold text-xs">Value from Utility</p>
              <p className="text-[#BDDBDB] text-xs">Driven by service demand</p>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-3 border border-[#1a1a1a] text-center">
              <p className="text-2xl mb-1">⏳</p>
              <p className="text-white font-semibold text-xs">Long-term Focus</p>
              <p className="text-[#BDDBDB] text-xs">Designed for sustainable use</p>
            </div>
          </div>
          <p className="mt-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <div className="space-y-3 mt-3">
                <div>
                  <p className="text-[#BDDBDB] text-xs uppercase tracking-wider">Purpose</p>
                  <p className="text-[#BDDBDB] text-sm">Entertainment, community, viral marketing</p>
                </div>
                <div>
                  <p className="text-[#BDDBDB] text-xs uppercase tracking-wider">Value Source</p>
                  <p className="text-[#BDDBDB] text-sm">Community sentiment, social media buzz</p>
                </div>
                <div>
                  <p className="text-[#BDDBDB] text-xs uppercase tracking-wider">Distribution</p>
                  <p className="text-[#BDDBDB] text-sm">Fair launches, airdrops, viral campaigns</p>
                </div>
                <div>
                  <p className="text-[#BDDBDB] text-xs uppercase tracking-wider">Longevity</p>
                  <p className="text-[#BDDBDB] text-sm">Depends on community engagement</p>
                </div>
              </div>
            </div>
            <div className="bg-[#050505]/40 rounded-xl p-4 border border-[#1a1a1a]">
              ...
              <div className="space-y-3 mt-3">
                <div>
                  <p className="text-[#BDDBDB] text-xs uppercase tracking-wider">Purpose</p>
                  <p className="text-[#BDDBDB] text-sm">Platform access, services, governance</p>
                </div>
                <div>
                  <p className="text-[#BDDBDB] text-xs uppercase tracking-wider">Value Source</p>
                  <p className="text-[#BDDBDB] text-sm">Demand for underlying services</p>
                </div>
                <div>
                  <p className="text-[#BDDBDB] text-xs uppercase tracking-wider">Distribution</p>
                  <p className="text-[#BDDBDB] text-sm">Presales, platform rewards, staking</p>
                </div>
                <div>
                  <p className="text-[#BDDBDB] text-xs uppercase tracking-wider">Longevity</p>
                  <p className="text-[#BDDBDB] text-sm">Tied to platform success and demand</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4">
              <h3 className="text-[#FF2D2D] font-semibold text-lg text-center">🎭 Choose a Meme Coin If:</h3>
            ...
            <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4">
              <h3 className="text-[#FF2D2D] font-semibold text-lg text-center">⚙️ Choose a Utility Token If:</h3>
              <ul className="list-disc pl-5 mt-3 space-y-1 text-[#BDDBDB] text-sm">
          ...
          <div className="bg-[#FF2D2D]/10 border border-[#FF2D2D]/30 rounded-xl p-4 mt-4">
            <p className="text-[#FF2D2D] text-sm font-semibold">🔄 Hybrid Approach</p>
            <p className="text-[#BDDBDB] text-sm mt-1">
        ...
        <section>
          ...
          <p className="text-[#BDDBDB] text-xs mt-2">⚠️ Meme coins are highly volatile and many fail. Success requires significant marketing effort and community management.</p>
          ...
          <p className="text-[#BDDBDB] text-xs mt-2">💡 Building a successful utility token requires significant platform development and user acquisition.</p>
        </section>
